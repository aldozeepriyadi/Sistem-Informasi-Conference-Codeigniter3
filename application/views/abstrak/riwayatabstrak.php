                    ...
                    <tbody>
                        ...
                        <?php foreach ($abstrak as $dis) { ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo $dis->statusDistribusi ?>
                                </td>
                                <td>
                                    <?php echo $dis->KataKunci ?>
                                </td>
                                <td>
                                    <?php echo $dis->deadlineRevisi ?>
                                </td>
                                <td>
                                    <a type="button" href="<?php echo site_url('history/viewhistory/' . $dis->IdAbstrak); ?>" class="btn icon icon-left btn-info" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Daftar Author"><i style="color:black;" class="bi bi-list-ul"></i>
                                        <!-- Detail -->
                                    </a>
