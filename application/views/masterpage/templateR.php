...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('aset/css/pages/summernote.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('aset/extensions/summernote/summernote-lite.css') ?>">
    <style>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item <?php echo
                            ...
                            <a href="<?php echo site_url('dashboard/dashboardR'); ?>" class='sidebar-link'>
                        ...
                        <li class="sidebar-item <?php echo
                                                $this->uri->segment(1) == 'abstrak' ? 'active' : ''; ?> ">
                            <a href="<?php echo site_url('abstrak/ReviewAbstrak'); ?>" class='sidebar-link'>
                                <i class="bi bi-blockquote-left"></i>
                                <span>Review Abstrak</span>
                            </a>
                        </li>

                        <li class="sidebar-item  <?php echo
                                                    $this->uri->segment(1) == 'fullpaper' ? 'active' : ''; ?> ">
                            <a href="<?php echo site_url('fullpaper/ReviewFullpaper'); ?>" class='sidebar-link'>
                                <i class="bi bi-file-earmark-text"></i>
                                <span>Review Fullpaper</span>
                            </a>
                        </li>

                        <li class="sidebar-item  <?php echo
                                                    $this->uri->segment(2) == 'abstrak' ? 'active' : ''; ?> <?php echo
                                                                                                            $this->uri->segment(2) == 'viewhistory' ? 'active' : ''; ?> ">
                            <a href="<?php echo site_url('history/abstrak'); ?>" class='sidebar-link'>
                                <i class="bi bi-clock-history"></i>
                                <span>Riwayat abstrak</span>
                            </a>
                        </li>
                        <li class="sidebar-item  <?php echo
                                                    $this->uri->segment(2) == 'fullpaper' ? 'active' : ''; ?> <?php echo
                                                                                                                $this->uri->segment(2) == 'viewfullpaper' ? 'active' : ''; ?>">
                            <a href="<?php echo site_url('history/fullpaper'); ?>" class='sidebar-link'>
                                <i class="bi bi-hourglass-split"></i>
                                <span>Riwayat fullpaper</span>
                            </a>
                        </li>
