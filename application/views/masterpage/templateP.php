...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('aset/extensions/choices.js/public/assets/styles/choices.css') ?>">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item <?php echo
                            ...
                            <a href=" <?php echo site_url('dashboard/dashboardP'); ?>" class='sidebar-link'>
                        ...
                        <li class="sidebar-item <?php echo
                            ...
                            <a href="<?php echo site_url('abstrak/cardEvent'); ?>" class='sidebar-link'>
                        ...
                        <li class="sidebar-item <?php echo
                                                $this->uri->segment(1) == 'payment' ? 'active' : ''; ?>">
                            <a href="<?php echo site_url('payment'); ?>" class='sidebar-link'>
                                <i class="bi bi-credit-card"></i>
                                <span>Pembayaran Abstrak</span>
                            </a>
                        </li>

                        <li class="sidebar-item <?php echo
                                                $this->uri->segment(1) == 'fullpaper' ? 'active' : ''; ?>">
                            <a href="<?php echo site_url('fullpaper'); ?>" class='sidebar-link'>
