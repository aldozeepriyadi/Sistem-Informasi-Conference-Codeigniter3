                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item <?php echo
                            ...
                            <a href="<?php echo site_url('dashboard/dashboardSA'); ?>" class='sidebar-link'>
                        ...
                        <li class="sidebar-item <?php echo
                                                $this->uri->segment(2) == 'user' ? 'active' : ''; ?>"">
                            <a href=" <?php echo site_url('user/user'); ?>" class='sidebar-link'>
                        ...
                        <li class="sidebar-item <?php echo
                                                $this->uri->segment(2) == 'author' ? 'active' : ''; ?>"">
                            <a href=" <?php echo site_url('user/author'); ?>" class='sidebar-link'>
                            <i class="bi bi-person"></i>
                            <span>Lihat Author</span>
                            </a>
                        </li>

                        <li class="sidebar-item <?php echo
                                                $this->uri->segment(2) == 'event' ? 'active' : ''; ?>"">
                            <a href=" <?php echo site_url('event/event'); ?>" class='sidebar-link'>
                        ...
                        <li class="sidebar-item <?php echo
                                                $this->uri->segment(1) == 'report' ? 'active' : ''; ?> has-sub">
                            <a href="#" class='sidebar-link'>
                                <i class="bi bi-file-text"></i>
                                <span>Laporan</span>
                            </a>
                            <ul class="submenu active">
                                <li class="submenu-item <?php echo
                                                        $this->uri->segment(2) == 'abstrak' ? 'active' : ''; ?>">
                                    <a href="<?php echo site_url('report/abstrak'); ?>">Abstrak</a>
                                </li>
                                <li class="submenu-item <?php echo
                                                        $this->uri->segment(2) == 'grafikpaymentindex' ? 'active' : ''; ?> ">
                                    <a href="<?php echo site_url('report/grafikpaymentindex'); ?>">Pembayaran</a>
                                </li>
                                <li class="submenu-item <?php echo
                                                        $this->uri->segment(2) == 'fullpaper' ? 'active' : ''; ?>">
                                    <a href="<?php echo site_url('report/fullpaper'); ?>">Fullpaper</a>
                                </li>
                            </ul>
                        </li>
