                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <?php foreach ($jmlabstrakditerima as $a) { ?>
                                            <h6 class="font-extrabold mb-0"><?php echo $a->jmlAOK ?></h6>
                                        <?php } ?>
                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <?php foreach ($jmlfppditerima as $b) { ?>
                                            <h6 class="font-extrabold mb-0"><?php echo $b->jmlFOK ?></h6>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Abstrak Direvisi</h6>
                                        <?php foreach ($jmlabstrakrevisi as $c) { ?>
                                            <h6 class="font-extrabold mb-0"><?php echo $c->jmlAOR ?></h6>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Fullpaper Direvisi</h6>
                                        <?php foreach ($jmlfpprevisi as $d) { ?>
                                            <h6 class="font-extrabold mb-0"><?php echo $d->jmlFR ?></h6>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    swalWithBootstrapButtons.fire(
                        ...
                        window.location = url + "dashboard/UbahStatusNotifP/" + id;
