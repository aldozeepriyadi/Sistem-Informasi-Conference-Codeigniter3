                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <?php foreach ($jumlahauthor as $c) { ?>
                                            <h6 class="font-extrabold mb-0"><?php echo $c->Author ?></h6>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            <?php foreach ($notif as $n) { ?>
                                                <tr id="<?php echo $n['IdNotif']; ?>">
                                                    ...
                                                    <td class="col-auto">
                                                        <!-- <a href="<?php echo site_url('dashboard/UbahStatusNotifSA/' . $n['IdNotif']) ?>" class="btn icon btn-success tombol-confirm" type="button">
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    swalWithBootstrapButtons.fire(
                        ...
                        window.location = url + "dashboard/UbahStatusNotifSA/" + id;
